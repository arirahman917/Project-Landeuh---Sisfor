...
>
    <div class="relative w-full max-w-xl mx-4 bg-[#fdf6e3] rounded-3xl shadow-2xl border border-amber-200/60
        ...
        <div class="flex items-center justify-between px-8 pt-7 pb-0">
            <div>
                <h2 class="text-xl font-bold text-stone-800 tracking-tight">Liburkan Kamar (Blokir Tanggal)</h2>
                <p class="text-xs text-stone-400 mt-0.5">Tentukan kamar dan tanggal yang ingin diliburkan dari pemesanan</p>
            </div>
            <button onclick="closeLiburKamarModal()" class="p-2 rounded-xl text-stone-400 hover:bg-stone-200/60 hover:text-stone-600 transition">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12"/></svg>
            </button>
        </div>

        {{-- Form Content --}}
        <div id="liburKamarFormWrap" class="px-8 pt-5 pb-3">
            <label class="block text-xs font-semibold text-stone-600 mb-1.5 tracking-wider uppercase">Pilih Kamar (Bisa Lebih Dari Satu)</label>
            <div id="liburKamarCheckboxes" class="grid grid-cols-2 gap-2 p-3 bg-white rounded-xl border border-stone-200 max-h-[150px] overflow-y-auto mb-4">
            ...
            <input type="text" id="liburKamar_name" placeholder="Misal: Perbaikan Kamar Mandi, Libur Cluster"
            ...
            <div class="mb-4">
                <input type="text" id="liburKamar_dates" class="hidden">
                <button type="button" id="btnOpenKalenderLibur"
        ...
        <div class="flex items-center justify-end gap-3 px-8 pb-7 pt-2">
            <button onclick="closeLiburKamarModal()"
            ...
            <button id="btnSaveLiburKamar" onclick="submitLiburKamar()"
            ...
            <button id="btnSaveAfterLiburKamarConflictsCleared" onclick="submitLiburKamar()" class="hidden px-8 py-2.5 rounded-full text-sm font-bold text-white bg-green-600 hover:bg-green-700 transition-all shadow-md active:scale-95">
