...
<script>
    ...
    function handleLoginSubmit(e) {
        ...
        // Extract a fake name from email
        const fakeName = email.split('@')[0];

        // Show success modal directly (No Verification for Login)
        hideAllLoginModals();
        ...
        setTimeout(() => {
            closeLoginModal();
            // Call the loginMockUser function from modal-register.blade.php
            if (typeof loginMockUser === 'function') {
                loginMockUser(fakeName, email, '');
            }
        }, 2000);
    }
